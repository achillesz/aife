<template>
  <div class="home flex">
    <div class="header flex justify-between items-center px-4 h-16">
      <div class="logo">AIFE</div>
      <a-avatar :style="{ backgroundColor: '#00d0b6' }">Design</a-avatar>
    </div>
    <div class="main flex">
      <div
        class="home-first flex-[1_1_auto] flex flex-col justify-center items-center pt-10"
        v-if="isFirstChat"
      >
        <div class="one-title text-3xl mb-1 font-bold">
          <span class="inline-block w-8 h-8 mr-2 align-middle">
            <svg
              ...
              <defs>
                ...
                <g id="__lottie_element_108">
                  ...
                  >
                    <g
                      opacity="1"
                      transform="matrix(1,0,0,1,88.25,88.25)"
                    >
                      <path
                ...
                >
                  <stop
                    offset="0%"
                    stop-color="rgb(52,107,241)"
                  ></stop>
                  <stop
                    offset="22%"
                    stop-color="rgb(50,121,248)"
                  ></stop>
                  <stop
                    offset="45%"
                    stop-color="rgb(49,134,255)"
                  ></stop>
                  <stop
                    offset="72%"
                    stop-color="rgb(64,147,255)"
                  ></stop>
                  <stop
                    offset="99%"
                    stop-color="rgb(79,160,255)"
                  ></stop>
                </linearGradient>
                <linearGradient
                ...
                <mask
                  id="__lottie_element_108_1"
                  mask-type="alpha"
                >
                  <use xlink:href="#__lottie_element_108"></use>
                </mask>
              </defs>
              <g clip-path="url(#__lottie_element_101)">
                <g
                  mask="url(#__lottie_element_108_1)"
                  style="display: block;"
                >
                  <g
                    transform="matrix(0.12479999661445618,0,0,0.12479999661445618,4.986400604248047,4.986400604248047)"
        ...
        <div class="two-title text-4xl mb-1 font-bold"> It’s time to start counting down to 2026
        </div>
        <div class="chat-area">
          <chat></chat>
        </div>
        <div class="chat-types">
          <div class="chat-type"> ☃️ Create image </div>
          <div class="chat-type"> ❄️ Write anything </div>
          <div class="chat-type"> ❄️ Create video</div>
          <div class="chat-type"> Help me learn </div>
          <div class="chat-type"> Boost my day </div>
        </div>
